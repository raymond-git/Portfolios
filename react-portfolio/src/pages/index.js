        ...
        <section className="min-h-screen">
          <nav className='py-10 mb-12 flex justify-between'>
            ...
            <ul className='flex items-center'>
              ...
              <li><a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8' target="_blank" href="https://publuu.com/flip-book/109878/295297">Resume</a></li>
            </ul>
          </nav>
            ...
            <div className='lg:grid grid-cols-3 justify-between gap-10'>
              ...
              <div className='rounder-xl p-10 shadow-lg my-10 border'>
                ...
                <div className='py-2'>
                  ...
                  <a className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-2 py-3 mt-12 rounded-md flex justify-center project-card btn btn-lg btn-block btn-outline-primary font-medium' target="_blank" href="https://main--funny-parfait-f7a211.netlify.app/">View Project</a>
                </div>
              </div>
              <div className='rounder-xl p-10 shadow-lg my-10 border'>
